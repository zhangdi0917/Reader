...
public class BookListActivity extends Activity {
    ...
    private void loadData() {
        ...
        Book book0 = new Book(0, "三国演义", "罗贯中", R.drawable.sanguoyanyi, "滚滚长江东逝水，浪花淘尽英雄。是非成败转头空。青山依旧在，几度夕阳红。白发渔樵江渚上，惯看秋月春风。一壶浊酒喜相逢。古今多少事，都付笑谈中。", "sanguoyanyi.txt", "GBK");
        mBookList.add(book0);
        Book book1 = new Book(1, "红楼梦", "曹雪芹", R.drawable.hongloumeng, "花谢花飞飞满天，红消香断有谁怜？游丝软系飘春榭，落絮轻沾扑绣帘。天尽头，何处有香丘？未若锦囊收艳骨，一抔净土掩风流。质本洁来还洁去，强于污淖陷渠沟。一年三百六十日，风刀霜剑严相逼。", "hongloumeng.txt", "GBK");
        mBookList.add(book1);
        Book book2 = new Book(
                2,
                "水浒传",
                ...
                "shuihuzhuan.txt", "GBK");
        mBookList.add(book2);
        Book book3 = new Book(3, "西游记", "吴承恩", R.drawable.xiyouji, "《西游记》是一部中国古典神魔小说，为中国“四大名著”之一。成书于16世纪明朝中叶，是最优秀的神话小说，也是一部群众创作和文人创作相结合的作品。《西游记》主要描写的是孙悟空保唐僧西天取经，历经九九八十一难的故事。", "xiyouji.txt", "GBK");
        mBookList.add(book3);
    }
